...
<form class="form-horizontal" > 
 ...
 <script>
   ...
   function copySquare()
	{  
		mdpitx.clearRect(0,0, 48,48);
		hdpitx.clearRect(0,0, 72,72);
		xhdpitx.clearRect(0,0, 96,96);
		xxhdpitx.clearRect(0,0, 144,144);
		xxxhdpitx.clearRect(0,0, 192,192);
		i6ponetx.clearRect(0,0, 66,66);
		i65onetx.clearRect(0,0, 44,44);
		i4sonetx.clearRect(0,0, 44,44);
		iPadonetx.clearRect(0,0, 44,44);
		iPad2onetx.clearRect(0,0, 22,22);
		i6ptwotx.clearRect(0,0, 75,75);
		i65twotx.clearRect(0,0, 50,50);
		i4stwotx.clearRect(0,0, 50,50);
		iPadtwotx.clearRect(0,0, 50,50);
		iPad2twotx.clearRect(0,0, 25,25);
		i6pthreetx.clearRect(0,0, 87,87);
		i65threetx.clearRect(0,0, 58,58);
		i4sthreetx.clearRect(0,0, 58,58);
		iPadthreetx.clearRect(0,0, 58,58);
		iPad2threetx.clearRect(0,0, 29,29);
		i6pfourtx.clearRect(0,0, 120,120);
		i65fourtx.clearRect(0,0, 80,80);
		i4sfourtx.clearRect(0,0, 80,80);
		iPadfourtx.clearRect(0,0, 80,80);
		iPad2fourtx.clearRect(0,0, 40,40);
		i6pfivetx.clearRect(0,0, 180,180);
		i65fivetx.clearRect(0,0, 120,120);
		i4sfivetx.clearRect(0,0, 120,120);
		iPadfivetx.clearRect(0,0, 152,152);
		iPad2fivetx.clearRect(0,0, 76,76);
 ...
 <div class="col-lg-5"></div>AGENAPP Copyright &copy; 2015 <a href="matt.w.g.baldock@gmail.com">Matthew Baldock.</a> All rights reserved
 </footer>
 </body>
